...
set.seed(911)
RF_Class_Weighted <- randomForest(Outcome~., data = training, ntree = 500, mtry = 8) # ,classwt=c(0.001,10000)
...
partial(RF_Final, pred.var = c("Agent"), plot= TRUE, prob = TRUE, which.class = 2)
